...
export const i18n = {
  ...
  home: {
    ...
    coreSub:          b('Engineered for global deployment — any climate, terrain or regulatory environment.', '面向全球部署而生——应对任何气候、地形与合规挑战。'),
    coreViieTitle:    b('VesselOS · VIIE', 'VesselOS · 智能交互'),
    coreViieSub:      b('Intelligent Interaction', '微宿智能控制系统'),
    coreViieDesc:     b('Proprietary platform. 1,400+ units globally connected. Full remote control of lighting, climate, access and monitoring.', '完全自研平台，全球1,400余台舱体联网，远程掌控灯光、空调、门锁与实时监控。'),
    coreVolsTitle:    b('VOLS · Off-grid System', 'VOLS · 离网系统'),
    coreVolsSub:      b('Energy Independence', '太阳能 · 储能 · 零排放'),
    coreVolsDesc:     b('Solar generation + 100kWh+ storage + VSRB zero-discharge treatment. No municipal infrastructure needed.', '光伏发电 + 100kWh+储能 + VSRB生物污水零排放，完全脱离市政水电基础设施。'),
    coreVipcTitle:    b('VIPC · Pre-fab System', 'VIPC · 整装预制'),
    coreVipcSub:      b('Factory Complete', '出厂即成品'),
    coreVipcDesc:     b('100% finished at factory. 2-hour site installation. 40ft Flat Rack compliant. 30+ countries delivered.', '工厂100%成品出厂，现场2小时完成安装，符合40尺平架集装箱规格，已合规交付30余国。'),
    coreLearnMore:    b('View Details →', '查看详情 →'),
  ...
  about: {
    ...
    stat6Val:         b('10M+', '1000万+'),
    stat6:            b('Social Followers', '全网粉丝'),
  ...
  auth: {
    ...
    roleInvestor:       b('Investor', '投资方'),
    roleInvestorDesc:   b('Evaluate sites or invest in hospitality assets', '评估营地或住宿资产投资'),
    ...
    completeTitle:      b('Complete Profile', '完善资料'),
    completeSubtitle:   b('Select your role to continue', '请选择您的身份以继续'),
    completeBtn:        b('Save and Continue', '保存并继续'),
    completing:         b('Saving...', '保存中...'),
    completeError:      b('Unable to save profile, please try again', '资料保存失败，请重试'),
  },
  form: {
