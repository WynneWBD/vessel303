...
export const products: ProductData[] = [
  ...
  },
  {
    ...
    tags_cn: ['舒适', '经典型号'],
    tags_en: ['Comfort', 'Reference Model'],
...
export const catalogProducts: CatalogProduct[] = [
  ...
  { id: 'e7-gen5-standard', productSeries: 'E7', name_cn: 'E7 Gen5 · 国标版', name_en: 'E7 Gen5 · China Standard', gen: 'Gen5', size: '38㎡', area: 38, generation: 5, productType: 'luxury', badge_cn: '经典豪华', badge_en: 'Classic Luxury', tags_cn: ['经典型号', '经典'], tags_en: ['Reference Model', 'Classic'], features_cn: ['270°环幕客厅', '礼宾级行政空间', '全屋电动窗帘'], features_en: ['270° encircling living room', 'Concierge-level space', 'Full electric curtains'], image: '/images/products/E7-Gen5_render-01.jpg', isCustom: false, detailSlug: 'e7-gen5' },
