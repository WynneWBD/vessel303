...
export const CONVERSION_PATHS: ConversionPathItem[] = [
  ...
  },
  {
    ...
    cta: 'News list/detail Contact CTA with source parameter',
    leadCapture: 'Routes to new site contact form',
    sourceRule: 'news:list:contact_cta / news:{slug}:contact_cta -> contact:main:inquiry_form',
    status: 'lead',
    risk: 'News still routes through the shared Contact form instead of embedding a form in reading pages, keeping articles light while preserving source_type=news attribution.',
  },
  {
    key: 'contact',
    area: 'Contact',
