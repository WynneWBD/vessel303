...
export const DEFAULT_PAGE_MODULES: PageModuleRow[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'empty-state', label_zh: '暂无匹配产品。', label_en: 'No matching products.', is_visible: true, sort_order: 100 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'nav-news', href: '/news', value_zh: 'primary', value_en: 'primary', label_zh: '新闻活动', label_en: 'News', is_visible: true, sort_order: 50 },
  ...
  },
  {
    ...
    items: [
      { id: 'phone', href: 'tel:4008090303', label_zh: '电话咨询', label_en: 'Call', is_visible: true, sort_order: 10 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'e6', href: '/products/e6', value_zh: '29.6㎡', value_en: '29.6 sqm', label_zh: 'E6 Gen6', label_en: 'E6 Gen6', is_visible: true, sort_order: 20 },
      { id: 'e3', href: '/products/e3', value_zh: '19㎡ mini', value_en: '19 sqm mini', label_zh: 'E3 Gen6', label_en: 'E3 Gen6', is_visible: true, sort_order: 30 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'news', href: '/news', label_zh: '新闻活动', label_en: 'News', is_visible: true, sort_order: 30 },
  ...
  },
  {
    ...
    items: [
      { id: 'phone', href: 'tel:4008090303', label_zh: '400-8090-303', label_en: '400-8090-303', content_zh: '工作时间以团队回复为准', content_en: 'Response time depends on team availability', is_visible: true, sort_order: 10 },
      { id: 'email', href: 'mailto:vessel.sale@303industries.cn', label_zh: 'vessel.sale@303industries.cn', label_en: 'vessel.sale@303industries.cn', is_visible: true, sort_order: 20 },
