...
export const CONTENT_CONTRACTS: ContentContract[] = [
  {
    ...
    previewHref: '/',
    modulePageKey: 'home',
    requiredModules: ['hero', 'credentials', 'operating-proof'],
    signals: ['image', 'cta', 'seo', 'navigation', 'footer'],
  ...
  },
  {
    ...
    previewHref: '/about',
    modulePageKey: 'about',
    requiredModules: ['hero', 'stats', 'brand-story', 'factory'],
    signals: ['image', 'cta', 'seo'],
    displayRule: 'About 前台只展示 about 已发布模块和固定展示模板。',
    hiddenRule: '模块未发布或隐藏时，前台隐藏该模块。',
    note: 'B26 不在前台补品牌说明，所有客户可见文字回后台模块维护。',
  },
  {
    key: 'products',
    title: '产品中心',
  ...
  },
  {
    ...
    contentSource: 'site_settings.contactUrl + page_modules:contact',
    adminHref: '/admin/site/settings',
    previewHref: '/contact',
    modulePageKey: 'contact',
    requiredModules: ['redirect'],
    signals: ['cta', 'source'],
    displayRule: '/contact 读取后台 contactUrl 并跳转；自有表单继续写 leads。',
    hiddenRule: 'contactUrl 不可用时只显示系统级安全状态。',
    note: '当前运营仍主要承接 300 联系页，B26 不改主联系页方向。',
  },
  {
    key: 'site-shell',
    title: '导航 / 页脚 / 共用文案',
  ...
  },
  {
    ...
    previewHref: '/global',
    signals: [],
    displayRule: 'B26 只登记边界，不修改地图底层。',
    hiddenRule: '地图底层问题回 04 专项。',
    note: 'Global 是独立地图展示渠道，不是案例详情页。',
