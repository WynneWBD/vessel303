  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="text-white text-2xl font-black mt-3 tracking-wider">登录账号</h1>
        <p className="text-white/35 text-sm mt-1 tracking-wider">登录后查看完整产品价格</p>
      </div>
      ...
      <div className="bg-[#0f0f0f] border border-white/8 p-8">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-white/20 text-xs tracking-wider">或使用邮箱</span>
          <div className="flex-1 h-px bg-white/8" />
        </div>
      ...
      <p className="text-center text-white/30 text-sm mt-6 tracking-wider">
        还没有账号？{' '}
        <Link href="/register" className="text-[#c9a84c] hover:text-[#d4b55a] transition-colors">
          立即注册
        </Link>
      </p>
    </div>
