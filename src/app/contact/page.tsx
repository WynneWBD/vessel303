      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="text-[#E36F2C] text-xs tracking-[0.3em] uppercase mb-6 font-medium">{t(i18n.contact.formLabel)}</div>
            <ContactForm />
          </div>
          ...
          <div className="space-y-6">
            <div>
              <div className="text-[#E36F2C] text-xs tracking-[0.3em] uppercase mb-6 font-medium">{t(i18n.contact.contactLabel)}</div>
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-4 bg-white border border-[#E5DED4]">
                  <div className="w-8 h-8 flex items-center justify-center bg-[#E36F2C]/10 shrink-0">
                    <svg className="w-4 h-4 text-[#E36F2C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <a href="tel:4008090303" className="text-[#2C2A28] font-bold tracking-wider hover:text-[#E36F2C] transition-colors">
                      400-8090-303
                    </a>
                ...
                <div className="flex items-start gap-4 p-4 bg-white border border-[#E5DED4]">
                  ...
                  <div>
                    ...
                    <a href="tel:+8618024176679" className="text-[#2C2A28] font-bold tracking-wider hover:text-[#E36F2C] transition-colors">
                      +86 180-2417-6679
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-white border border-[#E5DED4]">
                  ...
                  <div>
                    ...
                    <a href="mailto:wynne@303vessel.cn" className="text-[#444444] text-sm hover:text-[#E36F2C] transition-colors break-all">
                      wynne@303vessel.cn
                    </a>
                  </div>
                </div>
            ...
            {/* QR code placeholder */}
            <div className="p-5 bg-white border border-[#E5DED4] text-center">
              <div className="text-[#999999] text-xs tracking-wider mb-3">{t(i18n.contact.wechatLabel)}</div>
              <div className="w-28 h-28 mx-auto bg-[#E5DED4] flex items-center justify-center">
        ...
        <div className="mt-20">
          <div className="text-center mb-10">
            <div className="text-[#E36F2C] text-xs tracking-[0.3em] uppercase mb-3 font-medium">{t(i18n.contact.faqLabel)}</div>
            <h2 className="text-2xl font-black text-[#2C2A28]">{t(i18n.contact.faqTitle)}</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {faqs.map((faq, i) => (
              <div key={i} className="bg-white border border-[#E5DED4] p-6 hover:border-[#E36F2C]/20 transition-all">
                <div className="flex items-start gap-3">
                  <span className="text-[#E36F2C] font-black text-lg shrink-0 leading-none mt-0.5">Q</span>
                  <div>
