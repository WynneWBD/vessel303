              ...
              {milestones.map((m, i) => (
                <div key={i} className="flex gap-6 items-start pl-0 group">
                  ...
                  <div className="relative flex items-center shrink-0 mt-0.5">
                    <div className="w-3 h-3 border-2 border-[#c9a84c] bg-white rounded-full group-hover:bg-[#c9a84c] transition-colors" />
                  </div>
                  {/* Content */}
                  <div className="pb-6 flex-1">
                    <p className="text-[#555555] text-sm tracking-wider group-hover:text-[#333333] transition-colors leading-relaxed">
                      {m.event}
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-10">
            {globalRegions.map((item) => (
              <div key={item.region} className="bg-white border border-[#E8E4DE] p-4 text-center">
                <div className="text-[#c9a84c] font-bold mb-1 tracking-wider text-sm">{item.region}</div>
                <div className="text-[#999999] text-xs leading-relaxed">{item.countries}</div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 border-b border-[#F0EDE8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {honors.map((honor) => (
              <div key={honor} className="bg-white border border-[#E8E4DE] hover:border-[#c9a84c]/30 transition-all p-5 text-center group">
