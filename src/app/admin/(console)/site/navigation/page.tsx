...
const NAVIGATION_ITEMS: NavigationItem[] = [
  {
    ...
    owner: '产品管理 2.0',
    status: 'cms',
    note: '列表和详情内容由产品后台维护；B23 继续复核移动端筛选、产品图比例、详情锚点和询盘触达，导航位置暂不开放后台排序。',
    Icon: Package,
  },
  {
    label: 'Cases',
  ...
  },
  {
    ...
    owner: '页面可视化编辑',
    status: 'live',
    note: 'About 模块内容可编辑；B23 继续复核移动端首屏、图片比例和咨询入口层级，导航文字和位置仍由代码控制。',
    Icon: FileText,
  },
  {
    label: 'FAQ',
    ...
    owner: 'FAQ CMS',
    status: 'cms',
    note: '常见问题内容由固定 FAQ CMS 维护；B23 继续复核移动端阅读节奏、按钮触达和线索承接提示，导航文字和位置仍由代码控制。',
    Icon: ListChecks,
  },
  {
    label: 'News',
  ...
  },
  {
    ...
    owner: '页面可视化编辑',
    status: 'live',
    note: '页脚入口与顶部 About 保持一致；B23 继续对齐 300 的产品目录、项目证据、移动端体验和咨询路径说明。',
    Icon: FileText,
  },
  {
    label: 'Cases',
  ...
  {
    label: 'Tourism & Resort',
    href: '/scenarios/tourism',
    group: '页脚导航',
    source: 'Footer.tsx',
    owner: '场景方案 CMS',
    status: 'cms',
    note: '固定场景页内容由 Scenarios CMS 维护，页脚入口仍由代码控制。',
    Icon: Presentation,
  },
  {
        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-[#61767D]">
              当前阶段把前台导航、行动按钮和页脚入口集中给运营人员查看；B23 补充产品目录、产品详情、项目案例、FAQ、About 和内容专题的移动端与图片比例复核边界，避免在代码、CMS 和站点设置之间来回查找。
            </p>
          </div>
