  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F5F2ED]">
      ...
      <section className="bg-[#1A1A1A] pt-28 pb-20 px-4 relative overflow-hidden">
        <div className="absolute inset-0 opacity-5" style={{ backgroundImage: 'radial-gradient(circle at 30% 60%, #E36F2C 0%, transparent 55%)' }} />
        <div className="max-w-5xl mx-auto relative">
          <p className="text-[#E36F2C] text-xs tracking-[0.35em] uppercase font-medium mb-4">
            {zh ? '微宿离网系统' : 'VESSEL Off-grid Living System'}
          </p>
          ...
          <p className="text-[#C4B9AB] text-lg sm:text-xl">
            {zh ? '太阳能发电 · 储能 · 净水 · 污水零排放' : 'Vessel Off-grid Living System'}
          </p>
          <div className="flex gap-2 mt-8 flex-wrap">
            {[
              zh ? '太阳能' : 'Solar',
              zh ? '100kWh+ 储能' : '100kWh+ Storage',
              zh ? '零污染排放' : 'Zero Pollution',
              'Lotus Cars Partnership',
            ].map(tag => (
