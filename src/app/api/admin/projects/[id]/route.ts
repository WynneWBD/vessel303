...
const patchSchema = z.object({
  ...
  global_open_date: z.string().max(80).optional(),
  global_units: z.coerce.number().int().min(0).max(9999).nullable().optional(),
  global_unit_area: z.coerce.number().min(0).max(99999).nullable().optional(),
  global_guests: z.string().max(80).optional(),
  global_booking_url: z.string().max(500).optional(),
