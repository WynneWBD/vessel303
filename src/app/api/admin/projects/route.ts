...
const projectSchema = z.object({
  ...
  global_open_date: z.string().max(80).optional().default(''),
  global_units: z.coerce.number().int().min(0).max(9999).nullable().optional().default(null),
  global_unit_area: z.coerce.number().min(0).max(99999).nullable().optional().default(null),
  global_guests: z.string().max(80).optional().default(''),
  global_booking_url: z.string().max(500).optional().default(''),
