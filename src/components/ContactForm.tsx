  ...
  if (status === 'success') {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        <div className="w-16 h-16 rounded-full border-2 border-[#E36F2C] flex items-center justify-center mb-6">
          <svg className="w-8 h-8 text-[#E36F2C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button
          ...
          className="mt-8 text-xs border border-[#E5DED4] text-[#888888] hover:border-[#E36F2C]/40 hover:text-[#E36F2C] px-5 py-2 transition-all tracking-wider"
        >
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full bg-white border border-[#E5DED4] text-[#444444] text-sm px-4 py-3 focus:outline-none focus:border-[#E36F2C]/60"
          >
      ...
      <button
        ...
        className="w-full bg-[#E36F2C] text-white font-bold text-sm py-4 hover:bg-[#C85A1F] disabled:opacity-60 transition-colors tracking-[0.2em] uppercase"
      >
