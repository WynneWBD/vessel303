        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="mb-4">
              ...
              <div className="text-white/30 text-xs tracking-[0.3em]">微宿®·文旅智能装配建筑</div>
            </div>
            ...
            <div className="text-white/20 text-xs space-y-1">
              ...
              <div>邮箱: 303vessel@303industries.cn</div>
            </div>
          </div>

          {/* Products */}
          <div>
            <h4 className="text-white text-xs font-semibold tracking-[0.25em] mb-5 uppercase">产品系列</h4>
            <ul className="space-y-2.5">
              {[
                ['E7 Gen6', '38㎡ 旗舰版', '/products/e7'],
                ['E6 Gen6', '30㎡ 明星版', '/products/e6'],
                ['E3 Gen6', '19㎡ mini版', '/products/e3'],
                ['V9 Gen6', '38㎡ 家居版', '/products/v9'],
                ['V5 Gen5', '25㎡ 全景版', '/products/v5'],
                ['S5 Gen5', '30㎡ 天光版', '/products/s5'],
                ['全部产品', '', '/products'],
              ].map(([name, desc, href]) => (
                <li key={name}>
                  <Link
                  ...
                  >
                    ...
                    {desc && <span className="text-white/20 text-xs">{desc}</span>}
                  </Link>
                </li>
              ))}
            </ul>
          ...
          {/* Company */}
          <div>
            <h4 className="text-white text-xs font-semibold tracking-[0.25em] mb-5 uppercase">公司</h4>
            <ul className="space-y-2.5">
              {[
                ['关于我们', '/about'],
                ['项目案例', '/cases'],
                ['新闻活动', '/news'],
                ['联系我们', '/contact'],
                ['文旅度假', '/scenarios/tourism'],
                ['商业空间', '/scenarios/commercial'],
                ['公共设施', '/scenarios/public'],
              ].map(([name, href]) => (
                <li key={name}>
                  <Link
                    href={href}
          ...
          {/* Contact */}
          <div>
            <h4 className="text-white text-xs font-semibold tracking-[0.25em] mb-5 uppercase">联系我们</h4>
      ...
      <div className="border-t border-white/5 py-5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="text-white/20 text-xs tracking-wider">
            © 2024 VESSEL 微宿® · 303 Industries. 保留所有权利。
          </div>
          <div className="flex items-center gap-4">
            <Link href="#" className="text-white/20 hover:text-white/40 text-xs tracking-wider transition-colors">隐私政策</Link>
            <span className="text-white/10">·</span>
            <Link href="#" className="text-white/20 hover:text-white/40 text-xs tracking-wider transition-colors">使用条款</Link>
            <span className="text-white/10">·</span>
