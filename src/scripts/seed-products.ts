...
const products = [
  ...
  },
  {
    ...
    weight: '约5吨',
    capacity: '1-2人',
    design_philosophy: '以游艇立面美学为设计语言，无痕光域灯带环绕全身，半圆弧形玻璃窗以紧凑尺寸实现 180° 无遮挡景观视野。',
    badge: '入门推荐',
    image: '/images/e6-gen6.jpg',
    accent_color: '#E36F2C',
  ...
  },
  {
    ...
    weight: '约6吨',
    capacity: '1-2人',
    design_philosophy: '以超广角全景玻璃为核心，将自然景色充分引入室内。轻量化 6 吨结构支持快速运输部署，是打造景观度假营地的理想单元。',
    badge: '两人度假',
    image: '/images/v9-gen6.jpg',
    accent_color: '#E36F2C',
  ...
  },
  {
    ...
    weight: '约7吨',
    capacity: '2-4人',
    design_philosophy: '超越空间感，尽收天光云景。独特的天窗采光系统将自然光线垂直引入室内，随时间变化的光影成为空间独特的装饰。',
    badge: '景观推荐',
    image: '/images/e6-gen6.jpg',
    accent_color: '#E36F2C',
    ...
    features: [
      ...
      { title: '多面大窗视野', desc: '多方向大面积玻璃设计，多方位全面观景体验。' },
