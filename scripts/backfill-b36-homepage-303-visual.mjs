...
async function patchHomeHero(client, changes) {
  ...
  const next = {
    ...
    items: [
      ...
      item('hero-image-01', 'Fully-assembled modular cabin systems for resort projects', 100, {
        value_zh: 'Product systems',
        value_en: 'Product systems',
        content_zh: 'Route buyers from the first screen into models, project references and buyer materials.',
        content_en: 'Route buyers from the first screen into models, project references and buyer materials.',
        href: '/products',
        image_url: '/images/hero/optimized/homepage_banner-02.jpg',
      }),
      item('hero-image-02', 'Model families for hospitality, showroom and destination use', 110, {
        value_zh: 'Model range',
        value_en: 'Model range',
        content_zh: 'Expose V9, E7, E6 and E3 as a clear catalog path before visitors start searching.',
        content_en: 'Expose V9, E7, E6 and E3 as a clear catalog path before visitors start searching.',
        href: '/products',
        image_url: '/images/hero/optimized/homepage_banner-03.jpg',
      }),
      item('hero-image-03', 'Move from product interest to a sales conversation', 120, {
        value_zh: 'Project inquiry',
        value_en: 'Project inquiry',
        content_zh: 'Connect factory proof, published cases, buyer downloads and the contact path in one homepage flow.',
        content_en: 'Connect factory proof, published cases, buyer downloads and the contact path in one homepage flow.',
