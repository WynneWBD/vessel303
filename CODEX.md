...
- 最近功能批次：B380 / `0da5a13 feat(products): add row next actions`
- 已记录生产验证：B380 / `dpl_FrPGwx3Q38a4Yn94WhbgKoiEE9jc`；最新 production deployment 以 `vercel inspect https://www.vessel303.com` 为准。
