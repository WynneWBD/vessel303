...
- 最近功能批次：B378 / `8ed983a feat(admin): surface priority ledger on console`
- 已记录生产验证：B378 / `dpl_yhWgmB78VzMwNaWrsfMn48xzkjZv`；最新 production deployment 以 `vercel inspect https://www.vessel303.com` 为准。
