...
- 最近功能批次：B384 / `ade40ed feat(news): add row next actions`
- 已记录生产验证：B384 / `dpl_4gBuxMaxZf9hfna1pcb4J3E9NTkU`；最新 production deployment 以 `npx vercel inspect https://www.vessel303.com --scope vessel303` 为准。
